---
title: "VS Code Extensions Are Client/Server Apps (Nobody Told Me Either)"
subtitle: "How a debugging session revealed what the documentation never says."
date: 2026-02-16
tags: [vscode, architecture, client-server, developer-tools]
---
...
*Written with Claude Opus 4.6 — because sometimes the most useful documentation is the documentation that doesn't exist yet, and I'm too busy writing and reviewing code to not take advantage of a tool that allows me to disseminate what I'm thinking.*
