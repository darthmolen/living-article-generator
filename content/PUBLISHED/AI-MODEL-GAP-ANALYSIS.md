# Knowledge, Behavior, or Capability?

*Your model is underperforming. RAG vs. fine-tune is the wrong question — diagnose the gap before you build the pipeline.*

> The follow-up to [AI-DECISION-PROCESS.md](AI-DECISION-PROCESS.md). That piece gets a step
