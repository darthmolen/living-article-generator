# Code, Optimizer, or Model?

*A decision process for what AI should actually do — and why handing number problems to a language model burns tokens.*
...
[AI-MODEL-GAP-ANALYSIS.md](AI-MODEL-GAP-ANALYSIS.md).
